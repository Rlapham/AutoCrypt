...
- Window (pool creations): **2026-06-03 12:31 → 2026-06-03 22:38 UTC**  (~10.1h of wall-clock)
- `pool_created` rows: **12,165** over **11,553** distinct mints
...
| stage | count |
|---|---:|
| bonding-curve-origin mints (denominator) | 10,557 |
| → graduated (BC→AMM, incl. suspect) | 496 |
| → **genuine** graduations (lag ≥ 120s) | 181 |
| → suspect co-launch artifacts | 315 |
| never graduated (died on the curve) | 10,061 |
| direct-AMM launches (deep from birth, no BC) | 996 |

**Genuine graduation rate: 1.71%** (181/10557 bonding-curve-origin mints).
